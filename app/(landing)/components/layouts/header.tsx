...
const Header = () => {
  ...
  return (
    <header className="fixed w-full z-20 backdrop-blur-xl bg-white/50">
      <div className="flex items-center justify-between gap-10 container mx-auto py-7">
        <Link href="/">
          <Image
            src="/images/logo.svg"
            alt="sporton logo"
        ...
        <div className="relative flex items-center gap-5">
          ...
          >
            ...
            {items.length ? (
              <div className="bg-primary rounded-full min-w-[16px] h-4 absolute -top-1.5 -right-1.5 text-[10px] text-white flex items-center justify-center px-0.5">
                {items.length}
              </div>
            ) : (
              <></>
